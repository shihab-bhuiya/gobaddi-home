...
export default function WhoWeAre() {
  return (
   ...
   <div className="absolute bottom-0 left-0 z-20 hidden h-full w-full lg:block">
  <Image
  ...
  />
      ...
      <div className="relative z-20 mx-auto flex max-w-2xl flex-col items-center px-4 text-center">
            ...
            <button className="bg-[#FBE6DA] font-extrabold text-[18px] leading-[100%] uppercase tracking-[10%] font-[SF_Pro] text-[#C0612B] border-[#C0612B] border-2 rounded-2xl px-2 py-1 mb-4 ">
              About Us
            </button>
        ...
        <p className="lg:text-[26px] font-[SF_Pro] leading-[140%] text-[#262626] md:text-base">
     ...
     {/* Layer 4: Cards - straddles the sky/field seam */}
      <div className="relative z-30 mx-auto grid w-full max-w-[1312px] grid-cols-1 items-start justify-items-center gap-6 px-4 sm:mt-16 md:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:gap-8">
